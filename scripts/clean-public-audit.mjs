...
must(generatedStatus.includes("sourceDate: '2026-") && /sourceDate: '[0-9]{4}-[0-9]{2}-[0-9]{2}'/.test(generatedStatus), 'Generated public status must contain a dated sourceDate.')
