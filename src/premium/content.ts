...
const ru: typeof en = {
  ...
  hero:{eyebrow:'АВТОМАТИЗАЦИЯ СО СМЫСЛОМ · SOLANA',line1:'Умные деньги.',line2:'Ваши правила.',intro:'Следуйте за осмысленными решениями, а не за каждой сделкой. Мы создаём автономную торговлю вокруг выбранных вами кошельков и заданных вами границ.',primary:'Посмотреть, как это работает',secondary:'На каком мы этапе',label:'ТЕХНИЧЕСКАЯ АЛЬФА',stamp:'Контроль остаётся у вас.',bottom:'Без передачи средств платформе. С исполнением в рамках лимитов.',imageLabel:'ВИДЕНИЕ COPYPUMP',hint:'Что стоит между сигналом и сделкой'},
