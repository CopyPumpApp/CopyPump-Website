...
const en = {
  ...
  hero: {eyebrow:'INTELLIGENT AUTOMATION · SOLANA', line1:'Smart money.', line2:'Your rules.', intro:'A new way to follow conviction, not every trade. CopyPump is building autonomous trading around the wallets you choose and the boundaries you set.', primary:'Explore the experience', secondary:'Where we are today', label:'TECHNICAL ALPHA', stamp:'Designed for your control.', bottom:'Non-custodial by design. Built to act within limits.', imageLabel:'THE COPYPUMP VISION', hint:'Discover what sits between a signal and a trade'},
  experience: {eyebrow:'THE PRODUCT EXPERIENCE', title:'Intelligence finds the signal.', accent:'Your policy decides.', intro:'Explore the four parts of the intended workflow. This is an interactive product illustration, not a live trading terminal.', artLabel:'CANONICAL WORKFLOW OBJECT', example:'ILLUSTRATIVE DATA · NO TRANSACTION', detail:'Explore the control model', chapters:[
    {name:'Discover', title:'Watch conviction take shape.', copy:'Bring selected public wallets into one focused watchlist. Their activity creates candidates to examine—not instructions to copy blindly.', key:'SELECTED WALLET ACTIVITY', rows:[['Watchlist','Selected by you'],['Activity','New candidate'],['Action','Awaiting qualification']]},
  ...
  status: {eyebrow:'BUILDING WITH EVIDENCE', title:'Ambitious by design.', accent:'Honest about the stage.', intro:'The product is in technical alpha. The current focus is a complete, reviewable execution lifecycle on Solana Devnet.', label:'PROJECT SNAPSHOT', now:'Verification in progress', network:'Testing ground', mainnet:'Mainnet access', locked:'Intentionally locked', source:'Source updated', link:'Open the progress report', note:'Public launch follows verified readiness—not a countdown.'},
  cta: {eyebrow:'BUILD WITH COPYPUMP', title:'Be part of what comes next.', copy:'For traders who care about control, engineers who care about execution, and partners who see the same future.', community:'Join the conversation', builder:'Contribute to the project', partners:'Partnerships & enquiries'},
  ...
  progress: {eyebrow:'PROGRESS / PUBLIC RECORD', title:'Evidence before', accent:'access.', intro:'A clear separation between what is available, what is being verified, and what is not open yet.', date:'Public source updated', summaryTitle:'Technical alpha.', summaryCopy:'CopyPump is validating its trading lifecycle on Solana Devnet. The public website is available; public Mainnet trading is not.', currentLabel:'CURRENT ENGINEERING TARGET', currentTitle:'Prove the complete lifecycle.', currentCopy:'Buy → position → partial sell → full sell. Review transaction confirmation, reconcile the resulting state, and account for fees and PnL. A working interface is not proof of this lifecycle.', gates:[
...
const ru: typeof en = {
  ...
  hero:{eyebrow:'ИНТЕЛЛЕКТУАЛЬНАЯ АВТОМАТИЗАЦИЯ · SOLANA',line1:'Умные деньги.',line2:'Ваши правила.',intro:'Следуйте за осмысленными решениями, а не за каждой сделкой. Мы создаём автономную торговлю вокруг выбранных вами кошельков и заданных вами границ.',primary:'Посмотреть, как это работает',secondary:'На каком мы этапе',label:'ТЕХНИЧЕСКАЯ АЛЬФА',stamp:'Контроль остаётся у вас.',bottom:'Без передачи средств платформе. С исполнением в рамках лимитов.',imageLabel:'ВИДЕНИЕ COPYPUMP',hint:'Что стоит между сигналом и сделкой'},
  experience:{eyebrow:'ЗНАКОМСТВО С ПРОДУКТОМ',title:'Интеллект находит сигнал.',accent:'Ваши правила решают.',intro:'Четыре части задуманного процесса. Это интерактивная иллюстрация продукта, а не работающий торговый терминал.',artLabel:'ОБЪЕКТ ПРОЦЕССА',example:'УСЛОВНЫЕ ДАННЫЕ · БЕЗ ТРАНЗАКЦИЙ',detail:'Подробнее о модели контроля',chapters:[
    {name:'Сигналы',title:'Замечать осмысленные действия.',copy:'Соберите выбранные публичные кошельки в один список наблюдения. Их активность становится поводом для проверки, а не приказом слепо повторить сделку.',key:'АКТИВНОСТЬ ВЫБРАННЫХ КОШЕЛЬКОВ',rows:[['Список наблюдения','Выбираете вы'],['Активность','Новый кандидат'],['Действие','Ожидает проверки']]},
  ...
  status:{eyebrow:'РАЗВИТИЕ С ПОДТВЕРЖДЕНИЯМИ',title:'Масштабное видение.',accent:'Честный статус.',intro:'Продукт находится в технической альфе. Сейчас фокус — полный, проверяемый цикл исполнения в Solana Devnet.',label:'СОСТОЯНИЕ ПРОЕКТА',now:'Проверка продолжается',network:'Среда проверки',mainnet:'Доступ в Mainnet',locked:'Намеренно закрыт',source:'Источник обновлён',link:'Открыть отчёт о прогрессе',note:'Публичный запуск следует за подтверждённой готовностью, а не за таймером.'},
  cta:{eyebrow:'СОЗДАЁМ COPYPUMP',title:'Участвуйте в следующем этапе.',copy:'Для трейдеров, которым важен контроль. Для инженеров, которым важно исполнение. Для партнёров, которые разделяют наше видение.',community:'Присоединиться к обсуждению',builder:'Помочь в разработке',partners:'Партнёрство и вопросы'},
  ...
  ],source:'Открыть исходный отчёт',update:'Это датированный публичный срез, а не мониторинг системы в реальном времени.'},
