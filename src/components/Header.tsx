...
export function Header({simple=false}:{simple?:boolean}){
  ...
  const desktopLinks=simple?[[ru?'Главная':'Home','/',undefined],[ru?'Прогресс':'Progress','/project','journal']]:[[c.product,'/', 'why-copypump'],[ru?'О проекте':'Project','/project',undefined],[c.progress,'/project','journal']]
